...
(function (NumericAttr) {
    NumericAttr[NumericAttr["Neg"] = -1] = "Neg";
    NumericAttr[NumericAttr["Pos"] = 1] = "Pos";
})(NumericAttr || (NumericAttr = {}));
var NumericSign;
(function (NumericSign) {
    NumericSign["Neg"] = "-";
    NumericSign["Pos"] = "+";
    NumericSign["Point"] = ".";
...
var HexElement;
(function (HexElement) {
    HexElement[HexElement["A"] = 65] = "A";
    HexElement[HexElement["a"] = 97] = "a";
    HexElement[HexElement["decimalCount"] = 10] = "decimalCount";
    HexElement[HexElement["diffCode"] = 32] = "diffCode";
    HexElement[HexElement["letterCount"] = 26] = "letterCount";
 ...
 */
const multiply = (num1, num2, hexType = 10) => {
 ...
 */
const outputFormat = (num, num1Info, num2Info) => {
    let numArr = num.split('');
    const totalPoint = num1Info.point + num2Info.point;
    // 计算小数点位置
    totalPoint && (numArr.splice(-totalPoint, 0, NumericSign.Point));
    // 前置多余0删除
    ...
    // 符号位处理
    num1Info.attr * num2Info.attr < 0 && (numArr.unshift(NumericSign.Neg));
    // 删除前置0
    return numArr.join('');
};
/**
 ...
 * @returns string
 */
const largeNumMulti = (num1, num2, hexType) => {
    const num1Info = checkParams(num1, hexType);
    const num2Info = checkParams(num2, hexType);
    // 数值字符串是否合法
...
exports.default = largeNumMulti;
/**
 * 验证
 */
const test1 = largeNumMulti('0.1', '0.1');
console.log('0.1 * 0.1 = ', test1);
console.assert(test1 === '0.01', 'Failed: 0.1 * 0.1 = 0.01');
const test2 = largeNumMulti('1234567890123456789', '987654321');
console.log('1234567890123456789 * 987654321 = ', test2);
console.assert(test2 === '1219326311248285321112635269', 'Failed: 1234567890123456789 * 987654321 = 1219326311248285321112635269');
const test3 = largeNumMulti('F', '0.2', 16);
console.log('F * 0.2 = ', test3);
console.assert(test3 === '1.E', 'Failed: F * 0.2 = 1.E');
const test4 = largeNumMulti('-0b10', '0B11');
console.log('-0b10 * 0B11 = ', test4);
console.assert(test4 === '-110', 'Failed: -0b10 * 0B11 = -110');
const test5 = largeNumMulti('N', '2', 30);
console.log('N * 2 = ', test4);
console.assert(test5 === '1T', `Failed: -0b10 * 0B11 = 1T，Correct: ${test5}`);
